  ...
  render() {
    ...
    return (
      <div>
        ...
        <h1>Design</h1>
          <p className="lead" >Design your garden by considering how you want to feel in your oasis. Why do you enjoy nature? </p>
          <h2>Style</h2>
          ...
          <p className="lead">The health of your plants depends on their environment. </p>
            ...
            <Row>
              ...
              <Col sm="4">
                ...
                <div>
                <a className="img-tag"  href="https://unsplash.com/@josefin?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge" target="_blank" rel="noopener noreferrer" title="Download free do whatever you want high-resolution photos from S O C I A L . C U T">
                <span className="span-style">
                  <svg className="svg-style" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 32 32">
                    <title>unsplash-logo</title>
                    <path d="M10 9V0h12v9H10zm12 5h10v18H0V14h10v9h12v-9z"></path>
